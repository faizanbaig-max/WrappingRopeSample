...
namespace WrappingRopeLibrary.Scripts
{
    ...
    public class RopeBase : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        protected void ProcessPendulum()
        {
            ...
            // If angle between piece and velocity vector near 90  degreas, suggest pendulum is free suspended
       ...
       private void BandRope(Piece sourcePiece, IEnumerable<GameObject> exclude, int recurtionCount)
        ...
        private void WrapObjects()
        {
            ...
            while (piece != null)
            {
                //var prevFrontBackPoint = piece.PrevFrontBandPoint; // It's why??? Finnaly in main loop in RopeBase all band point position is reseted. This piece instans will not be processed any more in this loop.
                // If piece is merge result
                ...
                //piece.PrevFrontBandPoint = prevFrontBackPoint; // It's why??? Finnaly in main loop in RopeBase all band point position is reseted. This piece instans will not be processed any more in this loop.
